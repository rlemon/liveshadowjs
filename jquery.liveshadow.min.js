...
2;d=$(f).offset()},l=a.color||q(r(this),a.desaturate),m=function(g){var h=d.left-g.clientX+e,b=d.top-g.clientY+c;g=a.constAngle-Math.atan2(h,b);b=Math.sqrt(h*h+b*b)+45;h=b<a.distance?b/a.distance*a.shadowLength:a.shadowLength;b=$.extend({a:b<a.distance?b/a.distance*a.opacity:a.opacity},l);a.invert&&(g*=-1);n(f,h,g,b)};k();n(f,a.shadowLength,a.constAngle-a.angle,$.extend({a:a.opacity},l));if(!a.isStatic)$(window).on("resize",k).on("mousemove touchmove",m)})};